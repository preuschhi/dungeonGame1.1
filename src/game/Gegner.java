...
public abstract class Gegner implements IMethoden {
	...
	Waffe waffeGegner;
	boolean waffeGegnerBogenOSchwert; // Wenn dieser Boolean auf true ist, hat der Gegner ein Schwert, bei false einen
										// Bogen.
	Spieler spieler;
	...
	// Konstruktor
	public Gegner(String nameGegner, int lebenGegner, double spielerWaffeHaltbarkeitAbzug, int goldFuerSpieler, boolean waffeGegenerBogenOSchwert) {
		super();
		...
		this.waffeGegnerBogenOSchwert = waffeGegenerBogenOSchwert;
	}
